                ...
                <div className="mx-auto pb-16 lg:pb-32 f-f-p container lg:mt-24 mt-12 px-4 xl:px-0">
                    <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8">
                        ...
                        <div className="flex flex-col my-8 lg:my-0 xl:my-0">
                            ...
                            <input name="city" type="email" className="focus:outline-none focus:border text-gray-700 font-normal w-full h-15 flex items-center p-2 mt-4 text-lg border-solid border-2 border-white rounded-md shadow pb-2 focus:ring-4 focus:ring-yellow-300" placeholder="esempio@email.com" />
                        </div>
                    </div>
