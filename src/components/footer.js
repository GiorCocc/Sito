            ...
            <div className="border-t border-gray-200">
                <div className="container flex flex-col flex-wrap items-center justify-between p-5 mx-auto md:flex-row">
                    ...
                    <div className="flex flex-wrap items-center justify-center mx-auto text-base text-center p-5">
                        <a href="/contact/" >
                            <div className="justify-center m-5 text-md text-center text-gray-100 hover:text-gray-800 bg-gray-700 hover:bg-giallo px-5 py-2 rounded-md">Contatti</div>
                        </a>
                        <a href="/about/">
                            <div className="justify-center m-5 text-md text-center text-gray-100 hover:text-gray-800 bg-gray-700  hover:bg-giallo px-5 py-2 rounded-md">About</div>
                        </a>
                    ...
                    <div className="flex justify-center md:justify-start">
                            <span className="flex justify-center mt-2 md:justify-start">
                                ...
                                <a target="_blank" rel="noreferrer" className="ml-4 hover:text-twitter" href="https://twitter.com/giorcocc" >
                                    <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                        className="w-5 h-5" viewBox="0 0 24 24">
                                        <path
                                ...
                                <a target="_blank" rel="noreferrer" className="ml-4 hover:text-linkedin" href="https://www.linkedin.com/in/giorgio-coccapani-4b7834186/">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="currentColor" strokeLinecap="round" 
                                        strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="-1 -1 26 26">
                                ...
                                <a target="_blank" rel="noreferrer" className="ml-4 hover:text-telegram" href="mailto: giorcocc@gmail.com">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="currentColor" strokeLinecap="round"
                                        strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="-1 -1 26 26">
