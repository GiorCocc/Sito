  ...
  return (
    <footer className="mt-10 text-gray-700 bg-transparent border-t body-font ">
      <div className="border-t border-gray-200">
        <div className="container px-3 flex flex-col flex-wrap items-center justify-between mx-auto md:flex-row">
          <div className="flex items-center w-48 font-medium text-gray-900 title-font md:mb-0">
            <svg
              version="1.0"
              xmlns="http://www.w3.org/2000/svg"
              width="150pt"
              height="100pt"
              viewBox="0 0 747.000000 334.000000"
            ...
            >
              ...
              >
                <path
                  d="M3445 2912 c-218 -49 -369 -130 -521 -279 -197 -192 -296 -404 -319
                ...
                />
                <path
                  d="M5650 2911 c-320 -71 -579 -269 -726 -556 -81 -157 -109 -278 -108
                ...
                />
                <path
                  d="M1734 2476 c-29 -29 -34 -41 -34 -81 0 -40 5 -52 34 -81 19 -19 41
                ...
                />
                <path
                  d="M240 1991 c-37 -36 -46 -72 -31 -122 16 -54 60 -82 119 -76 49 5 79
                ...
                />
                <path
                  d="M1041 1816 c-47 -26 -50 -46 -51 -287 l0 -227 29 -31 29 -31 237 0
                            237 0 29 29 29 29 0 232 c0 139 -4 239 -10 251 -24 43 -56 49 -287 49 -162 -1
                            -224 -4 -242 -14z"
                />
                <path
                  d="M772 1620 c-21 -13 -35 -31 -39 -50 l-5 -30 -159 0 -159 0 0 -130 c0
                ...
                />
                <path
                  d="M2024 1624 c-17 -8 -41 -33 -53 -54 -21 -38 -25 -40 -72 -40 -43 0
                ...
                />
                <path
                  d="M764 1236 c-26 -26 -34 -43 -34 -69 0 -39 30 -84 66 -97 20 -8 24
                ...
                />
                <path
                  d="M1673 1235 c-32 -32 -35 -39 -30 -78 6 -43 43 -87 73 -87 12 0 14
                ...
                />
                <path
                  d="M2680 611 c-22 -12 -44 -36 -59 -66 -23 -43 -24 -51 -13 -93 36 -140
                ...
                <path
                  d="M3079 607 c-77 -51 -91 -158 -29 -222 81 -84 219 -52 250 59 35 127
                            -112 236 -221 163z m109 -38 c91 -31 77 -160 -19 -175 -30 -5 -42 -1 -69 23
                            -25 22 -32 37 -32 65 0 45 6 54 46 79 36 22 34 22 74 8z"
                />
                <path
                  d="M3330 485 l0 -145 30 0 c30 0 30 0 30 58 l0 57 38 -57 c32 -51 41
                ...
                />
                <path
                  d="M3640 610 c-67 -35 -93 -126 -56 -197 63 -123 258 -86 273 51 l6 46
                ...
                />
                <path
                  d="M5062 610 c-95 -58 -95 -198 1 -255 36 -21 106 -21 147 0 l33 17 -20
                            20 c-17 16 -24 18 -41 9 -46 -25 -103 -5 -127 45 -37 78 40 153 121 119 29
                            -12 34 -11 49 5 16 18 16 20 -16 39 -43 27 -104 27 -147 1z"
                />
                <path
                  d="M5345 614 c-46 -24 -64 -44 -76 -85 -34 -111 67 -217 179 -187 20 5
                ...
                />
                <path
                  d="M5820 485 l0 -145 30 0 c29 0 30 2 30 45 l0 45 40 0 c59 0 105 43
                ...
                />
                <path
                  d="M6280 486 l0 -146 25 0 c24 0 25 2 25 75 0 53 4 75 12 75 7 0 48 -35
                ...
                <path
                  d="M5594 483 l-61 -138 26 -3 c18 -3 30 3 40 17 11 17 24 21 67 21 44 0
                ...
                />
                <path
                  d="M6054 489 c-32 -72 -60 -135 -62 -140 -2 -5 10 -9 26 -9 22 0 33 6
          ...
          <div className="flex flex-col md:flex-row gap-5 items-center justify-center mx-auto text-base text-center p-5">
            <Link
              to="/contact/"
          ...
          <div className="justify-center hidden md:flex md:justify-start md:visible">
            <span className="flex justify-center mt-2 md:justify-start">
              <a
                target="_blank"
                rel="noreferrer"
                className=" hover:text-facebook"
                href="https://www.facebook.com/giorcocc/"
              >
                <svg
                  class="h-5 w-5 text-black hover:text-facebook"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="2"
              ...
              <a
                target="_blank"
                rel="noreferrer"
                className="ml-4 hover:text-twitter"
                href="https://twitter.com/giorcocc"
              >
                <svg
                  class="h-5 w-5 text-black hover:text-twitter"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="2"
              ...
              <a
                target="_blank"
                rel="noreferrer"
                className="ml-4 hover:text-instagram"
                href="https://www.instagram.com/giorgio_coccapani/"
              >
                <svg
                  class="h-5 w-5 text-black hover:text-instagram"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="2"
              ...
              <a
                target="_blank"
                rel="noreferrer"
                className="ml-4 hover:text-linkedin"
                href="https://www.linkedin.com/in/giorgio-coccapani-4b7834186/"
              >
                <svg
                  class="h-5 w-5 text-black hover:text-linkedin"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="2"
              ...
              <a
                target="_blank"
                rel="noreferrer"
                className="ml-4 hover:text-github"
                href="https://github.com/GiorCocc"
              >
                <svg
                  class="h-5 w-5 text-black hover:text-github"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="2"
              ...
              <a
                target="_blank"
                rel="noreferrer"
                className="ml-4 hover:text-mail"
                href="mailto: giorcocc@gmail.com"
              >
                <svg
                  class="h-5 w-5 text-black hover:text-mail"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <a
                target="_blank"
                rel="noreferrer"
                className="ml-4 hover:text-telegram"
                href="https://t.me/giorcocc"
              >
                <svg
                  class="h-5 w-5 text-black hover:text-telegram"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                  stroke-width="2"
