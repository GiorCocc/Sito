        ...
        <footer className="mt-10 text-gray-700 bg-transparent border-t body-font">
            <div className="border-t border-gray-200">
                <div className="container flex flex-col flex-wrap items-center justify-between p-5 mx-auto md:flex-row">
                    ...
                    <div className="flex flex-wrap items-center justify-center mx-auto text-base text-center">
                        {/* <a href="/post/" class="justify-center mr-5 text-sm text-center text-gray-600 hover:text-gray-800">
                            Post</a>
                        <a href="/projects/" class="justify-center mr-5 text-sm text-center text-gray-600 hover:text-gray-800">
                            Progetti</a> */}
                        <a href="/contact/" class="justify-center mr-5 text-sm text-center text-gray-600 hover:text-gray-800">
                            Contatti</a>
                        <a href="/about/" class="justify-center mr-5 text-sm text-center text-gray-600 hover:text-gray-800">
                            About</a>
                    ...
                    <div className="inline-flex items-center justify-center md:justify-start s:hidden">
                            <span className="inline-flex justify-center mt-2 sm:ml-auto sm:justify-start">
                                <a className="ml-4 hover:text-blue-700" href="https://www.facebook.com/giorcocc/">
                                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        className="w-5 h-5" viewBox="0 0 24 24">
                                        <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                                    </svg>
                                </a>
                                <a class="ml-4 hover:text-blue-300" href="https://twitter.com/giorcocc">
                                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        className="w-5 h-5" viewBox="0 0 24 24">
                                        <path
                                ...
                                <a className="ml-4 hover:text-red-400" href="https://www.instagram.com/giorgio_coccapani/">
                                ...
                                <a className="ml-4 hover:text-blue-900" href="https://www.linkedin.com/in/giorgio-coccapani-4b7834186/">
                                ...
                                <a className="ml-4 hover:text-black" href="https://github.com/GiorCocc">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke="currentColor" stroke-linecap="round" 
                                        stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="-1 -1 26 26">
