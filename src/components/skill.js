        ...
        <div className="p-5 grid gap-4 sm:grid-cols-1 md:grid-cols-2">
            <div className="pb-5">
                <div className="flex flex-row">
                    ...
                    <p className="text-xl justify-center align-middle ml-5 text-gray-200">HTML</p>
                </div>
            ...
            <div className="pb-5">
                <div className="flex flex-row">
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#1572B6" className="w-9">
            ...
            <div className="pb-5">
                <div className="flex flex-row">
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#F7DF1E" className="w-9">
            ...
            <div className="pb-5">
                <div className="flex flex-row">
                    <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#00599C" className="w-9">
                        <title>C++ icon</title>
            ...
            <div className="pb-5">
                <div className="flex flex-row">
                <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#3776AB" className="w-9">
            ...
            <div className="pb-5">
                <div className="flex flex-row">
                    <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#008080" className="w-9">
            ...
            <div className="pb-5">
                <div className="flex flex-row">
                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#0095D5" className="w-9">
