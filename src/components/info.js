        ...
        <div className="f-f-p pt-16 lg:pt-32 mx-auto container px-4 xl:px-0">
                    ...
                    <div className="mt-12 lg:mt-24">
                        ...
                        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8">
                            <div className="bg-white cursor-pointer shadow-lg py-10 rounded-3xl flex flex-col items-center hover:bg-yellow-300 hover:shadow-2xl">
                            ...
                            <div className="bg-white shadow-lg cursor-pointer py-10 rounded-3xl flex flex-col items-center hover:bg-yellow-300 hover:shadow-2xl">
