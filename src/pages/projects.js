...
import siteproject from "../img/Logo-iniziali-e-nome1.png"
                    ...
                    <div>
                      ...
                      <div className="flex flex-col justify-between">
                        ...
                        <div className="flex flex-row place-self-end border rounded-full">
                          <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#00599C" className="h-7 p-0.5 place-self-center">
                            <title>C++ icon</title>
                ...
                <div>
                  <a href="https://github.com/GiorCocc/gioco-esame" target="_blank" rel="noreferrer" className="w-full p-1 md:p-2">
                    ...
                    <div className="flex flex-col justify-between">
                      ...
                      <div className="flex flex-row place-self-end border rounded-full">
                        <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#239120" className="h-7 p-0.5 place-self-center">
                ...
                <div className="w-full p-1 md:p-2">
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    <div className="flex flex-row gap-3">
                      <div className="flex flex-row place-self-end border rounded-full">
                        <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#C51A4A" className="h-7 p-0.5 place-self-center">
                        ...
                        <p className="text-center">Raspberry</p>
                      </div>
                      <div className="flex flex-row place-self-end border rounded-full">
                        <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#3776AB" className="h-7 p-0.5 place-self-center">
              ...
              <div className="flex flex-row">
                ...
                <a href="https://github.com/GiorCocc/arduino" target="_blank" rel="noreferrer" className="w-1/2 p-1 md:p-2">
                  <div>
                    ...
                    <div className="flex flex-col justify-between">
                      <p className="place-self-start align-center">Progetti università arduino</p>
                      <div className="flex flex-row gap-3">
                        <div className="flex flex-row place-self-end border rounded-full">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#00979D" className="h-7 p-0.5 place-self-center">
                  ...
                  <div className="w-1/2 p-1 md:p-2">
                    <a href="https://github.com/GiorCocc/Sito" target="_blank" rel="noreferrer">
                      ...
                      <div className="flex flex-col justify-between">
                        ...
                        <div className="flex flex-row gap-3">
                          <div className="flex flex-row place-self-end border rounded-full">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#E34F26" className="h-7 p-0.5 place-self-center">
                          ...
                          <div className="flex flex-row place-self-end border rounded-full">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#1572B6" className="h-7 p-0.5 place-self-center">
                        ...
                        <div className="flex flex-row place-self-end border rounded-full">
                            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#F7DF1E" className="h-7 p-0.5 place-self-center">
