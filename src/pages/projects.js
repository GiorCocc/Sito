...
const Projects=(props)=>(
  <div>
    ...
    <div className="f-f-p pt-16 lg:pt-32 mx-auto container px-4 md:px-8 xl:px-0">
      ...
      <p class="mt-3 text-base text-gray-500 justify-center text-center sm:mt-5 sm:text-lg sm:mx-auto md:mt-5 md:text-xl lg:mx-20"> 
        Qui trovate una raccolta dei progetti che ho realizzato che sono reperibili su <a href="https://github.com/GiorCocc" target="_blank" rel="noreferrer" className="text-giallo">GitHub</a> per un approfondimento e per contribuire, aggiornare e recuperare tutti i miei lavori
      </p>  
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-4 md:px-8 xl:mx-auto gap-3 py-6">
        {/* Due piccoli e uno grande */}
        <div className="">
          <div className="grid grid-cols-2 gap-3">
            {/* Piccolo */}
            <a href="https://github.com/GiorCocc/programmi-liceo" target="_blank" rel="noreferrer">
              <div className="flex flex-col gap-1">
                ...
                <div className="">
                  <p className="place-self-start break-words align-center">Programmi C/C++ Liceo</p>
                </div>
            ...
            {/* Piccolo */}
            <a href="https://github.com/GiorCocc/cpp-project-unipr" target="_blank" rel="noreferrer" className="">
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img alt="Programmi C/C++ Università" className="block object-cover object-center rounded-lg" fluid={props.data.cpp.childImageSharp.fluid}></Img>
                </div>
                <div className="">
            ...
            {/* Grande */}
            <a href="https://github.com/GiorCocc/gioco-esame" target="_blank" rel="noreferrer" className="col-span-2">
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img alt="Videogioco C# stile Super Mario" className="block object-cover object-center rounded-lg" fluid={props.data.bigboi.childImageSharp.fluid}></Img>
                </div>
                <div className="">
        ...
        <div className="">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="col-span-2">
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img alt="Robot cane powered by Raspberry" className="block object-cover object-center rounded-lg" fluid={props.data.dog.childImageSharp.fluid}></Img>
                </div>
                <div className="">
            ...
            {/* Piccolo */}
            <a href="https://github.com/GiorCocc/python_project-unipr" target="_blank" rel="noreferrer" className="">
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img alt="Programmi UniPr python" className="block object-cover object-center rounded-lg" fluid={props.data.python.childImageSharp.fluid}></Img>
                </div>
                <div className="">
            ...
            {/* Piccolo */}
            <a href="https://github.com/GiorCocc/arduino" target="_blank" rel="noreferrer" className="">
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img alt="Progetti di elettronica digitale con Arduino" className="block object-cover object-center rounded-lg" fluid={props.data.arduino.childImageSharp.fluid}></Img>
                </div>
                <div className="flex flex-row">
                  <p className="place-self-start align-center">Progetti Arduino Uno</p>
                </div>
                <div className="flex flex-row gap-2">
                  <div className="flex flex-row place-self-end border rounded-full">
        ...
        <div className="">
          <div className="grid grid-cols-2 gap-3">
            ...
            <a href="https://github.com/GiorCocc/Sito" target="_blank" rel="noreferrer" className="">
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img alt="Sito personale di Giorgio Coccapani" className="block object-cover object-center rounded-lg" fluid={props.data.logo.childImageSharp.fluid}></Img>
                </div>
                <div className="">
            ...
            {/* Piccolo */}
            <a href="https://github.com/GiorCocc/password-generator" target="_blank" rel="noreferrer" className="">
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img alt="Generatore di password casuali secondo regole specifiche" className="block object-cover object-center rounded-lg" fluid={props.data.password.childImageSharp.fluid}></Img>
                </div>
                <div className="flex flex-row">
        ...
        <div className="">
          <div className="grid grid-cols-2 gap-3">
            {/* Piccolo */}
            <a href="https://github.com/GiorCocc/bubble-bobble" target="_blank" rel="noreferrer">
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img alt="Classic Game Bubble bobble" className="block object-cover object-center rounded-lg" fluid={props.data.bb.childImageSharp.fluid}></Img>
                </div>
                <div className="">
                  <p className="place-self-start break-words align-center">Bubble Bobble</p>
                </div>
                <div className="flex flex-row gap-2">
                  <div className="flex flex-row place-self-end border rounded-full">
                    <svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#3776AB" className="h-7 mx-0.5 p-0.5 place-self-center">
            ...
            {/* Piccolo */}
            <a href="https://github.com/GiorCocc/3-in-a-row" target="_blank" rel="noreferrer" className="">
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img alt="GIoco matematico 3 in a row" className="block object-cover object-center rounded-lg" fluid={props.data.inarow.childImageSharp.fluid}></Img>
                </div>
                <div className="">
