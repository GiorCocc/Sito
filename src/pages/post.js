                ...
                <div className="mx-auto container">
                    ...
                    <div className="mt-12 lg:mt-24">
                        <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-8">
                            <div className="shadow-lg rounded-3xl hover:shadow-xl">
                                ...
                                <div className="py-4 px-8 w-full flex justify-between bg-yellow-300">
                                    <p className="text-sm text-white font-semibold tracking-wide">Giorgio Coccapani</p>
                                ...
                                <div className="bg-white px-10 py-6 rounded-bl-3xl rounded-br-3xl">
                                    <h1 className="text-4xl text-gray-900 font-semibold tracking-wider">Perchè il sito?</h1>
                                    ...
                                    <div className="w-full mt-4 justify-end flex items-center cursor-pointer">
                                        <p className="text-base tracking-wide">Continua</p>
                                        <svg className="ml-3 lg:ml-6" xmlns="http://www.w3.org/2000/svg" width={20} height={18} viewBox="0 0 20 18" fill="none">
                                            <path d="M11.7998 1L18.9998 8.53662L11.7998 16.0732" stroke="#ffc85b" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M1 8.53662H19" stroke="#ffc85b" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                ...
                                <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8">
                                    <div>
                                        ...
                                        <div className="bg-white px-6 py-4 rounded-bl-3xl rounded-br-3xl">
                                            <h1 className="text-lg text-gray-900 font-semibold tracking-wider">Come gestire al meglio le proprie finanze</h1>
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-white px-6 py-4 rounded-bl-3xl rounded-br-3xl">
                                            <h1 className="text-lg text-gray-900 font-semibold tracking-wider">Ecosistema</h1>
                                            <p className="text-gray-700 text-base leading-8 pr-4 tracking-wide mt-2">Primo paragrafo del post</p>
                                        </div>
                                    </div>
                                </div>
