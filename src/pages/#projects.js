          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img
                    alt="Programmi C/C++ liceo"
                    className="block object-cover object-center rounded-lg"
                    fluid={props.data.cpp.childImageSharp.fluid}
                  ></Img>
                </div>
                <div className="">
                  <p className="place-self-start break-words align-center">
                    Programmi C/C++ Liceo
                  </p>
                </div>
                <div className="flex flex-row gap-2">
                  <div className="flex flex-row place-self-end border rounded-full">
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="#00599C"
                      className="h-7 mx-0.5 p-0.5 place-self-center"
                    >
                      <title>C++ icon</title>
            ...
            >
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img
                    alt="Programmi C/C++ Università"
                    className="block object-cover object-center rounded-lg"
                    fluid={props.data.cpp.childImageSharp.fluid}
                  ></Img>
                </div>
                <div className="">
                  <p className="place-self-start align-center">
                    Programmi Università C++
                  </p>
                </div>
                <div className="flex flex-row gap-2">
                  <div className="flex flex-row place-self-end border rounded-full">
            ...
            >
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img
                    alt="Videogioco C# stile Super Mario"
                    className="block object-cover object-center rounded-lg"
                    fluid={props.data.bigboi.childImageSharp.fluid}
                  ></Img>
                </div>
                <div className="">
                  <p className="place-self-start align-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="col-span-2">
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img
                    alt="Robot cane powered by Raspberry"
                    className="block object-cover object-center rounded-lg"
                    fluid={props.data.dog.childImageSharp.fluid}
                  ></Img>
                </div>
                <div className="">
                  <p className="place-self-start align-center">
                    Robot Cane Raspberry
                  </p>
                </div>
                <div className="flex flex-row gap-2">
                  <div className="flex flex-row place-self-end border rounded-full">
            ...
            >
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img
                    alt="Programmi UniPr python"
                    className="block object-cover object-center rounded-lg"
                    fluid={props.data.python.childImageSharp.fluid}
                  ></Img>
                </div>
                <div className="">
                  <p className="place-self-start align-center">
                    Programmi UniPr python
                  </p>
                </div>
            ...
            >
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img
                    alt="Progetti di elettronica digitale con Arduino"
                    className="block object-cover object-center rounded-lg"
                    fluid={props.data.arduino.childImageSharp.fluid}
                  ></Img>
                </div>
                <div className="flex flex-row">
                  <p className="place-self-start align-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img
                    alt="Sito personale di Giorgio Coccapani"
                    className="block object-cover object-center rounded-lg"
                ...
                <div className="flex flex-row overflow-x-auto gap-2">
                  <div className="flex flex-row place-self-end border rounded-full">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      fill="#E34F26"
                      className="h-7 mx-1 p-0.5 place-self-center"
                    >
            ...
            >
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img
                    alt="Generatore di password casuali secondo regole specifiche"
                    className="block object-cover object-center rounded-lg"
                    fluid={props.data.password.childImageSharp.fluid}
                  ></Img>
                </div>
                <div className="flex flex-row">
                  <p className="place-self-start align-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img
                    alt="Classic Game Bubble bobble"
                    className="block object-cover object-center rounded-lg"
                    fluid={props.data.bb.childImageSharp.fluid}
                  ></Img>
                </div>
                <div className="">
                  <p className="place-self-start break-words align-center">
            ...
            >
              <div className="flex flex-col gap-1">
                <div className="">
                  <Img
                    alt="GIoco matematico 3 in a row"
                    className="block object-cover object-center rounded-lg"
                    fluid={props.data.inarow.childImageSharp.fluid}
                  ></Img>
                </div>
                <div className="">
